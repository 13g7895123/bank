...
| 19 | 京城商業銀行 | ❌ Timeout | - | 僅保留 114 年資料 |
| 20 | 匯豐(台灣)商業銀行 | ✅ | ✅ 8/8 | |
| 21 | 瑞興商業銀行 | ✅ | ❌ 0/8 | 掃描式 PDF，需 OCR |
| 22 | 華泰商業銀行 | ⚠️ 無資料 | - | 113Q4 尚無資料 |
| 23 | 臺灣新光商業銀行 | ✅ | ❌ 0/8 | PDF 解析失敗 |
| 24 | 陽信商業銀行 | ✅ | ✅ 8/8 | |
| 25 | 板信商業銀行 | ⚠️ 無資料 | - | 僅保留 114 年資料 |
...
| 16 | 臺灣中小企業銀行 | 環境問題 | 需要 wget 工具，建議改用 Playwright |
| 18 | 台中商業銀行 | Timeout | 網頁載入逾時 |
| 38 | 樂天國際商業銀行 | 環境問題 | Chromium 路徑問題 |
| 41 | 將來商業銀行 | Timeout | 網頁載入逾時 |

**建議**：
- 增加 timeout 時間（目前 60 秒）
- 檢查網站結構是否變更
- 移除 wget 依賴，統一使用 Playwright
...
這些銀行的 113Q4 資料可能尚未發布，或網站僅保留近期資料：
- 01 臺灣銀行、02 臺灣土地銀行、05 華南商業銀行、06 彰化商業銀行
- 07 上海商業儲蓄銀行、19 京城商業銀行、22 華泰商業銀行
- 25 板信商業銀行、26 三信商業銀行、28 遠東國際商業銀行
